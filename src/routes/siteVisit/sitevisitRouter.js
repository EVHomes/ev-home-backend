...
// siteVisitRouter.get("/fix-visits", async (req, res) => {
//   try {
//     const upList = jsonVisits.map((visit) => {
//       visit.projects = visit.projects.map((proj) => {
//         if (proj?.toLowerCase()?.includes("square")) {
//           proj = "project-ev-9-square-vashi-sector-9";
//         }
//         if (proj?.toLowerCase()?.includes("marina")) {
//           proj = "project-ev-10-marina-bay-vashi-sector-10";
//         }
